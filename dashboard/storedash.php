                        ...
                        $result =  mysqli_query($connection,$query);
                            if (mysqli_num_rows($result)  >0){
                                while ($row= mysqli_fetch_assoc($result)){
                                    $id  = $row['id'] ;
                                    $name = $row['name'] ;
                                    $action = "editstore.php?id=$id";
                                    $action_dels= "delete_store.php?$id";
                                    $logo = $row['Logo'];
                                    $address = $row['address'];
                                    $phone = $row['phone'];
                                ...
                                <td>test2</td>
                                <td>$category</td>
                                <td>  <a href='editstore.php?id=$id' class='btn btn-primary'>Edit</a> </td>
                               <td>
                                                <form class='c_form' action=$action_dels method='post'>
                                                
                                                <input type='hidden' name='id' value='$id'>
                                                
                                                    <button type='submit' class='btn btn-danger delete_store' id='deletes-btn'>
                                                        DELETE
                                                    </button>
                                                </form>
                                            </td>
                            ...
                            <div class="col-12">
                                ...
                                for ($i =1;$i<=$page_count;$i++){
                                    echo "<li class='page-item'>
                                                    <a href='storedash.php?page=".$i."' class ='page-link'>$i</a></li>";
