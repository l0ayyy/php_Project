...
<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="storedash.php">
              <span class="menu-icon">
                <i class="mdi mdi-newspaper-plus"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="addstore.php">
              <span class="menu-icon">
                <i class="mdi mdi-newspaper-plus"></i>
              </span>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="<?php echo "editstore.php?id=$id"?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="StoreName">Store Name</label>
                                        <input type="text" class="form-control" id="store_name" placeholder="store name" name="s_name" value="<?php echo $row['name']?>">
                                        <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="phone_number" placeholder="phone number" name="s_phone" value="<?php echo $row['phone']?>">
                                        <?php
                                        if (!empty($errors['name-error'])){
                                            echo "<span class='text-danger'>".$errors['name-error']."</span>";
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" placeholder="Address" name="s_address" value="<?php echo $row['address']?>">
                                        <?php
                                        if (!empty($errors['name-error'])){
                                            echo "<span class='text-danger'>".$errors['name-error']."</span>";
                                        }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="categoryselect" name="s_category_id">
                                            <option value="" disabled><Strong>category name :</Strong></option>
                                            <?php
                                            $c_query ='select id , name from category' ;
