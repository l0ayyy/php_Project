...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $category_id = $_POST['s_category_id'];
    ...
    if (count($errors) >0){
        ...
        $query="INSERT INTO store
                (name,address,phone,Logo,category_id)
                 VALUES('$s_name','$address','$phone','$file_new_name','$category_id')";
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="<?php echo $_SERVER['PHP_SELF'] ?>"method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="store_name" placeholder="store name" name="s_name">
                                        <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="phone_number" placeholder="phone number" name="s_phone">
                                    </div>
                                    <div class="form-group">
                                        <label for="Address">Address</label>
                                        <input type="text" class="form-control" id="address" placeholder="Address" name="s_address">
                                    </div>
                                    <div class="form-group">
